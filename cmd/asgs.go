...
// asgsCmd represents the asgs command
var asgsCmd = &cobra.Command{
	Use:   "asgs",
...
to quickly create a Cobra application.`,
	Run: func(cmd *cobra.Command, args []string) {
		//fmt.Println("asgs called")

		if ok, err := cmd.PersistentFlags().GetBool("debug"); err == nil {
			awsfunc.Logflg = ok
		}
...
func init() {
	...
	// asgsCmd.Flags().BoolP("toggle", "t", false, "Help message for toggle")
}
